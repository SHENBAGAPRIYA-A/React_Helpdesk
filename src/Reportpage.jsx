...
const ReportPage = () => {
  ...
  // Bar chart data (Tickets by Date)
  ...
  // Function to download the report (CSV)
  ...
  return (
    <div className="main-layout">
      {/* Sidebar and User Profile Drawer */}
      <Sidebar />
      <UserProfileDrawer />
      ...
      <div >
        ...
        <div className="charts">
          {/* Pie Chart for Ticket Status Breakdown */}
